...
public final class FragmentCategoryBinding implements ViewBinding {
  ...
  private FragmentCategoryBinding(@NonNull CoordinatorLayout rootView,
      @NonNull RecyclerView rcCategory, @NonNull Toolbar toolbar) {
  ...
  public static FragmentCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.rcCategory;
      RecyclerView rcCategory = rootView.findViewById(id);
      if (rcCategory == null) {
        break missingId;
      }
      ...
      return new FragmentCategoryBinding((CoordinatorLayout) rootView, rcCategory, toolbar);
    }
