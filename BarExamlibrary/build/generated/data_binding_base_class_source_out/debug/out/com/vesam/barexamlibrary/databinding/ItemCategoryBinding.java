...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull LinearLayoutCompat rootView, @NonNull LinearLayout lnParent,
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCategoryBinding((LinearLayoutCompat) rootView, lnParent, txtTitle);
    }
